...
Object_AttrFlags:
    ...
    .byte OAT_BOUNDBOX01 | OAT_HITNOTKILL | OAT_BOUNCEOFFOTHERS | OAT_ICEIMMUNITY   ; Object $74 - OBJ_ZOMBIEGOOMBA
...
Object_BumpOffOthers:
    LDA <Counter_1 
    AND #$01
    BEQ PRG000_CC6B  ; Semi-randomly jump to PRG000_CC6B (RTS)
...
PRG000_CC38:
    ...
    JSR Object_Move
    JSR Object_Move
    LDX <SlotIndexBackup     ; Y = object slot index
    RTS
